...
# Ultra-minimal dark theme with name, color, and shape settings
HTML_TEMPLATE = '''
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <script>
        ...
        // Populate shape grid - simplified, just empty boxes
